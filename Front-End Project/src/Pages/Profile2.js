...
const Profile2 = (props) => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:8080/findWorkoutByEmail", {params})
      .then((response) => {
...
const [editWorkout, setEditWorkout] = useState();
  const updateWorkout = () => {
    axios.post(
        "http://localhost:8080/updateWorkout", editWorkout
    )
    .then(
...
const editchangeHandler = (event) => {
    ...
    const tempWorkout = {...editWorkout};
    console.log(name)
    console.log(value)
    tempWorkout[name]= value;
    setEditWorkout(tempWorkout);
        ...
        <div className="row">
          {/* <nav className="col-md-2 d-none d-md-block bg-light sidebar">
            <div className="sidebar-sticky">
              <ul className="nav flex-column">
                ...
                {/* <li className="nav-item">
                  <Link className="nav-link" to="/profile/workouts">
                    <svg
                ...
                <li className="nav-item">
                  <Link className="nav-link" to="/profile/info">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
          ...
          <main role="main" className="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
              <h1 className="h2">{loggedInAthlete.firstName}'s Profile</h1>
            </div>
            <div>
...
<svg xmlns="http://www.w3.org/2000/svg" style={{display: 'none'}}>
  ...
  <symbol id="geo-fill" viewBox="0 0 16 16">
    <path fillRule="evenodd" d="M4 4a4 4 0 1 1 4.5 3.969V13.5a.5.5 0 0 1-1 0V7.97A4 4 0 0 1 4 3.999zm2.493 8.574a.5.5 0 0 1-.411.575c-.712.118-1.28.295-1.655.493a1.319 1.319 0 0 0-.37.265.301.301 0 0 0-.057.09V14l.002.008a.147.147 0 0 0 .016.033.617.617 0 0 0 .145.15c.165.13.435.27.813.395.751.25 1.82.414 3.024.414s2.273-.163 3.024-.414c.378-.126.648-.265.813-.395a.619.619 0 0 0 .146-.15.148.148 0 0 0 .015-.033L12 14v-.004a.301.301 0 0 0-.057-.09 1.318 1.318 0 0 0-.37-.264c-.376-.198-.943-.375-1.655-.493a.5.5 0 1 1 .164-.986c.77.127 1.452.328 1.957.594C12.5 13 13 13.4 13 14c0 .426-.26.752-.544.977-.29.228-.68.413-1.116.558-.878.293-2.059.465-3.34.465-1.281 0-2.462-.172-3.34-.465-.436-.145-.826-.33-1.116-.558C3.26 14.752 3 14.426 3 14c0-.599.5-1 .961-1.243.505-.266 1.187-.467 1.957-.594a.5.5 0 0 1 .575.411z" />
      ...
      <div class="feature col">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="21em" height="12em" fill="currentColor" class="bi bi-plus-square" viewBox="0 0 16 16">
  <path d="M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"/>
  <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
</svg>
        </div>
        <h2>Create Workout</h2>
        {/* <p>Build your workouts tailored towards achieving your fitness goal.</p> */}
        {/* <a href="#" class="icon-link"> */}
        <Link className="icon-link-brand" to="/workout">Click Here</Link>
        {/* </a> */}
      </div>
      <div class="feature col">
        <div class="feature-icon bg-primary bg-gradient">
          
       <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="21em" height="12em" viewBox="0 0 485.535 485.535" style={{enableBackground: 'new 0 0 485.535 485.535'}} xmlSpace="preserve">
  <g>
    <g id="_x35__13_">
      <g>
        ...
        {/* <a href="#" class="icon-link"> */}
        <Link className="icon-link" to="/profile/workouts">Click Here</Link>
      ...
      <div class="feature col">
        <div class="feature-icon bg-primary bg-gradient">
        <svg xmlns="http://www.w3.org/2000/svg" width="21em" height="12em" fill="currentColor" class="bi bi-calendar-date" viewBox="0 0 16 16">
  ...
  <path d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5zM1 4v10a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V4H1z"/>
        ...
        {/* <p>Build your workouts tailored towards achieving your fitness goal.</p> */}
        <a href="/calendar.html" class="icon-link">Click Here</a>
      </div>
      ...
      <div class="feature col">
        <div class="bi bi-person-square bg-primary bg-gradient">
        <svg xmlns="http://www.w3.org/2000/svg" width="21em" height="12em" fill="currentColor" class="bi bi-person-square" viewBox="0 0 16 16">
  <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z"/>
  <path d="M2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2zm12 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1v-1c0-1-1-4-6-4s-6 3-6 4v1a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h12z"/>
        ...
        {/* <a href="#" class="icon-link">
          Call to action */}
          <Link className="icon-link" to="/profile/info">Click Here</Link>
          {/* <svg class="bi" width="1em" height="1em"><use href="#chevron-right"/></svg> */}
        {/* </a> */}
      </div>
    </div>
            ...
            <Route path="/profile/workouts">
              <Workouts allWorkouts={allWorkouts} setEditWorkout={setEditWorkout} editWorkout={editWorkout} updateWorkout={updateWorkout} editchangeHandler={editchangeHandler} />
            </Route>

            <Route path="/profile/info">
                <Info loggedInAthlete={loggedInAthlete} />
            </Route>

            {/* <Route path="/lettuce/almonds">
